...
var UIController = (function () {
    ...
    return {
        ...
        displayBudget: function (obj) {
            ...
            document.querySelector(DStrings.budgetLabel).textContent = formatNumber(obj.budget, type);
            document.querySelector(DStrings.incomeLabel).textContent = formatNumber(obj.totalInc, 'inc');
            document.querySelector(DStrings.expensesLabel).textContent = formatNumber(obj.totalExp, 'exp');
        ...
        displayPercentages: function (percentages) {
            ...
            var fields = document.querySelectorAll(DStrings.expensesPercLabel);
        ...
        displayMonth: function () {
            ...
            document.querySelector(DStrings.monthAndYear).textContent = months[month] + ' ' + year;
        },

        changeType: function () {

            var fields = document.querySelectorAll(
                DStrings.expenseType + ',' +
                DStrings.expenseDescription + ',' +
                DStrings.expenseValue
            );

            nodeListForEach(fields, function (cur) {
                cur.classList.toggle('red-focus');
            });
            document.querySelector(DStrings.inputBtn).classList.toggle('red');
        },
...
var controller = (function (budgetCtrl, UICtrl) {
    ...
    var setupEventListners = function () {
        ...
        document.querySelector(DOM.expenseType).addEventListener('change', UICtrl.changeType);
    };
    ...
    var updatePercentages = function () {
        ...
        budgetCtrl.cacluatePercentages();
